...
public class ListSort {
	/**
	 * ListSort.sortList(list, "count", "desc");
	 * @param list
	 * @param sortField 瀛楁灞炴�
	 * @param sortMode desc鎴朼sc
	 */
		...
		Collections.sort(list, new Comparator<T>() {
			...
			public int compare(T o1, T o2) {
				try {
					...
					Field field = clazz.getDeclaredField(sortField); // 鑾峰彇鎴愬憳鍙橀噺
					field.setAccessible(true); // 璁剧疆鎴愬彲璁块棶鐘舵�
					String typeName = field.getType().getName().toLowerCase(); // 杞崲鎴愬皬鍐�

					Object v1 = field.get(o1); // 鑾峰彇field鐨勫�
					Object v2 = field.get(o2); // 鑾峰彇field鐨勫�

					boolean ASC_order = (sortMode == null || "ASC"
							.equalsIgnoreCase(sortMode));

					// 鍒ゆ柇瀛楁鏁版嵁绫诲瀷锛屽苟姣旇緝澶у皬
